...
"""
Example usage:
python3 project/src/main.py --trainInput '/<path>/demo_test_data/d_r_333_.jpg' --testInput '/<path>/demo_test_data/d_r_333_.jpg' --resultPath /<path>/demo_results/ --combine True --model mynet --nChannel 50 --lr 0.1 --maxIter 75
"""
